<?php
define("UZKOD","5377574286:AAFY9tIyte62UofxZV2koyuyfeec3dTaKU0");
$admin = "2134380527";
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"📲 Kanalimiz",'url'=>"t.me/win_gift_card"],['text'=>"👥 Guruhimiz",'url'=>"t.me/win_gift_card"]]
]
])
]);
}else{
...
'chat_id'=> $cid,
'parse_mode'=>"html",
'text'=>"🔵 <b>Kechirasiz</b> <a href='tg://user?id=$cid'>$name</a> <b>botdan to'liq foydalanish uchun</b> <a href='t.me/win_gift_card'>@win_gift_card</a> <b>kanaliga a'zo bo'ling va tekshirish tugmasini bosing!

📛 Agar kanaldan chiqib ketsangiz bot sizning guruhda ishlamay qoladi.</b>",
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"➕ A'zo bo'lish",'url'=>"t.me/win_gift_card"]],
...
'text'=>"📛 Siz @win_gift_card kanalimizga a'zo bo'lmadingiz!",
'show_alert'=>true,
]);
}
}
...
if ($tx == "/mymembers" or $tx == "/mymembers@TESTLERIM_BOT"){
if ($cty == "supergroup"){
if (!$replyid){
bot ('sendmessage', [
'chat_id'=> $cid,
...
if ($tx == "/top" or $tx == "/top@TESTLERIM_BOT"){
 if ($cty == "supergroup"){
$reyting = top($cid);
bot ('sendmessage', [
'chat_id'=> $cid,
...
if ($tx == "/setchannel" or $tx == "/start" or $tx == "/setchannel@TESTLERIM_BOT" or $tx == "/stat"){
if ($cty == "supergroup"){
$us = bot ('getChatMember', [
'chat_id'=> $chan,
'user_id'=> $uid,
